...
void MerkleRoot_3_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void MerkleRoot_3_run(uint ctx_index,Circom_CalcWit* ctx);
...
uint get_total_signal_no() {return 19488;}
...
ctx->componentMemory[coffset].templateName = "MerkleRoot";
ctx->componentMemory[coffset].signalStart = soffset;
...
for (uint i = 0; i < 1; i++) {
std::string new_cmp_name = "treeNodes[0]";
mySubcomponents[aux_create+i] = aux_cmp_num;
...
uint csoffset = mySignalStart+895;
for (uint i = 0; i < 1; i++) {
std::string new_cmp_name = "treeNodes[1]";
mySubcomponents[aux_create+i] = aux_cmp_num;
MiMCSponge_1_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
csoffset += 0 ;
aux_cmp_num += 0;
...
for (uint i = 0; i < 1; i++) {
std::string new_cmp_name = "treeNodes[2]";
mySubcomponents[aux_create+i] = aux_cmp_num;
MiMCSponge_1_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
csoffset += 0 ;
aux_cmp_num += 0;
...
uint csoffset = mySignalStart+2667;
for (uint i = 0; i < 1; i++) {
std::string new_cmp_name = "treeNodes[3]";
mySubcomponents[aux_create+i] = aux_cmp_num;
MiMCSponge_1_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
csoffset += 0 ;
aux_cmp_num += 0;
...
for (uint i = 0; i < 1; i++) {
std::string new_cmp_name = "treeNodes[4]";
mySubcomponents[aux_create+i] = aux_cmp_num;
MiMCSponge_1_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
csoffset += 0 ;
aux_cmp_num += 0;
...
for (uint i = 0; i < 1; i++) {
std::string new_cmp_name = "treeNodes[5]";
mySubcomponents[aux_create+i] = aux_cmp_num;
MiMCSponge_1_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
csoffset += 0 ;
aux_cmp_num += 0;
...
uint csoffset = mySignalStart+5325;
for (uint i = 0; i < 1; i++) {
std::string new_cmp_name = "treeNodes[6]";
mySubcomponents[aux_create+i] = aux_cmp_num;
MiMCSponge_1_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
csoffset += 0 ;
aux_cmp_num += 0;
...
for (uint i = 0; i < 1; i++) {
std::string new_cmp_name = "treeNodes[7]";
mySubcomponents[aux_create+i] = aux_cmp_num;
MiMCSponge_1_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
csoffset += 0 ;
aux_cmp_num += 0;
...
uint csoffset = mySignalStart+7097;
for (uint i = 0; i < 1; i++) {
std::string new_cmp_name = "treeNodes[8]";
mySubcomponents[aux_create+i] = aux_cmp_num;
...
uint csoffset = mySignalStart+8867;
for (uint i = 0; i < 1; i++) {
std::string new_cmp_name = "treeNodes[9]";
mySubcomponents[aux_create+i] = aux_cmp_num;
MiMCSponge_2_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
csoffset += 0 ;
aux_cmp_num += 0;
...
uint csoffset = mySignalStart+10637;
for (uint i = 0; i < 1; i++) {
std::string new_cmp_name = "treeNodes[10]";
mySubcomponents[aux_create+i] = aux_cmp_num;
MiMCSponge_2_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
csoffset += 0 ;
aux_cmp_num += 0;
...
uint csoffset = mySignalStart+12407;
for (uint i = 0; i < 1; i++) {
std::string new_cmp_name = "treeNodes[11]";
mySubcomponents[aux_create+i] = aux_cmp_num;
MiMCSponge_2_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
csoffset += 0 ;
aux_cmp_num += 0;
...
uint csoffset = mySignalStart+14177;
for (uint i = 0; i < 1; i++) {
std::string new_cmp_name = "treeNodes[12]";
mySubcomponents[aux_create+i] = aux_cmp_num;
MiMCSponge_2_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
csoffset += 0 ;
aux_cmp_num += 0;
...
uint csoffset = mySignalStart+15947;
for (uint i = 0; i < 1; i++) {
std::string new_cmp_name = "treeNodes[13]";
mySubcomponents[aux_create+i] = aux_cmp_num;
MiMCSponge_2_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
csoffset += 0 ;
aux_cmp_num += 0;
...
uint csoffset = mySignalStart+17717;
for (uint i = 0; i < 1; i++) {
std::string new_cmp_name = "treeNodes[14]";
mySubcomponents[aux_create+i] = aux_cmp_num;
MiMCSponge_2_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
csoffset += 0 ;
aux_cmp_num += 0;
...
Fr_lt(&expaux[0],&lvar[17],&circuitConstants[17]); // line circom 13
while(Fr_isTrue(&expaux[0])){
{
...
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[17])) + 1)]);
}
// run sub component if needed
if(!(--ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter)){
...
{
PFrElement aux_dest = &lvar[((1 * Fr_toInt(&lvar[17])) + 2)];
// load src
// end load src
Fr_copy(aux_dest,&ctx->signalValues[ctx->componentMemory[mySubcomponents[((1 * Fr_toInt(&lvar[17])) + 0)]].signalStart + ctx->templateInsId2IOSignalInfo[ctx->componentMemory[mySubcomponents[((1 * Fr_toInt(&lvar[17])) + 0)]].templateId].defs[0].offset+0]);
}
{
PFrElement aux_dest = &lvar[17];
// load src
Fr_add(&expaux[0],&lvar[17],&circuitConstants[3]); // line circom 13
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[17],&circuitConstants[17]); // line circom 13
...
Fr_lt(&expaux[0],&lvar[17],&circuitConstants[31]); // line circom 21
while(Fr_isTrue(&expaux[0])){
Fr_div(&expaux[2],&lvar[17],&circuitConstants[5]); // line circom 23
Fr_add(&expaux[1],&expaux[2],&circuitConstants[17]); // line circom 23
Fr_sub(&expaux[0],&expaux[1],&circuitConstants[3]); // line circom 23
{
...
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + ctx->templateInsId2IOSignalInfo[ctx->componentMemory[mySubcomponents[cmp_index_ref]].templateId].defs[1].offset+map_index_aux[0]];
// load src
Fr_sub(&expaux[0],&lvar[17],&circuitConstants[5]); // line circom 23
// end load src
Fr_copy(aux_dest,&lvar[((1 * Fr_toInt(&expaux[0])) + 2)]);
}
// run sub component if needed
if(!(--ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter)){
(*_functionTable[ctx->componentMemory[mySubcomponents[cmp_index_ref]].templateId])(mySubcomponents[cmp_index_ref],ctx);
...
Fr_div(&expaux[2],&lvar[17],&circuitConstants[5]); // line circom 24
Fr_add(&expaux[1],&expaux[2],&circuitConstants[17]); // line circom 24
Fr_sub(&expaux[0],&expaux[1],&circuitConstants[3]); // line circom 24
{
uint cmp_index_ref = ((1 * Fr_toInt(&expaux[0])) + 0);
{
uint map_index_aux[1];
...
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + ctx->templateInsId2IOSignalInfo[ctx->componentMemory[mySubcomponents[cmp_index_ref]].templateId].defs[1].offset+map_index_aux[0]];
// load src
Fr_sub(&expaux[0],&lvar[17],&circuitConstants[3]); // line circom 24
// end load src
Fr_copy(aux_dest,&lvar[((1 * Fr_toInt(&expaux[0])) + 2)]);
}
// run sub component if needed
...
Fr_div(&expaux[2],&lvar[17],&circuitConstants[5]); // line circom 25
Fr_add(&expaux[1],&expaux[2],&circuitConstants[17]); // line circom 25
Fr_sub(&expaux[0],&expaux[1],&circuitConstants[3]); // line circom 25
{
uint cmp_index_ref = ((1 * Fr_toInt(&expaux[0])) + 0);
{
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + ctx->templateInsId2IOSignalInfo[ctx->componentMemory[mySubcomponents[cmp_index_ref]].templateId].defs[2].offset];
...
Fr_div(&expaux[2],&lvar[17],&circuitConstants[5]); // line circom 26
Fr_add(&expaux[1],&expaux[2],&circuitConstants[17]); // line circom 26
Fr_sub(&expaux[0],&expaux[1],&circuitConstants[3]); // line circom 26
{
PFrElement aux_dest = &lvar[((1 * Fr_toInt(&expaux[0])) + 2)];
// load src
// end load src
Fr_copy(aux_dest,&ctx->signalValues[ctx->componentMemory[mySubcomponents[((1 * Fr_toInt(&lvar[17])) + 0)]].signalStart + ctx->templateInsId2IOSignalInfo[ctx->componentMemory[mySubcomponents[((1 * Fr_toInt(&lvar[17])) + 0)]].templateId].defs[0].offset+0]);
}
...
PFrElement aux_dest = &lvar[17];
// load src
Fr_add(&expaux[0],&lvar[17],&circuitConstants[5]); // line circom 21
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[17],&circuitConstants[31]); // line circom 21
...
// load src
// end load src
Fr_copy(aux_dest,&ctx->signalValues[ctx->componentMemory[mySubcomponents[14]].signalStart + ctx->templateInsId2IOSignalInfo[ctx->componentMemory[mySubcomponents[14]].templateId].defs[0].offset+0]);
}
}

void run(Circom_CalcWit* ctx){
MerkleRoot_3_create(1,0,ctx,"main",0);
MerkleRoot_3_run(0,ctx);
}
